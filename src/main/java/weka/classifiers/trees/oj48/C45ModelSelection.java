...
/**
 * Class for selecting a C4.5-like split for a given dataset.
 *
		...
		try{
			...
			for (i = 0; i < data.numAttributes(); i++){
				...
				if (i < (data).classIndex()){
					...
					currentModel[i] = new C45Split(i,m_minNoObj,sumOfWeights,m_useMDLcorrection,m_optimizationCrit);
